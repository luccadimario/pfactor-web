            ...
            <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-slate-900/70 border-b border-slate-700/50">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <a
                            href="https://apps.apple.com/app/pfactor"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="px-4 py-2 bg-sky-500 hover:bg-sky-400 text-white font-medium rounded-lg transition-colors"
                        >
                            Download App
                        </a>
                    </div>
                ...
                {/* Mobile menu */}
                {menuOpen && (
                    <div className="md:hidden bg-slate-900/95 backdrop-blur-md border-t border-slate-700/50 px-6 py-4 space-y-4">
                        <a
                            href="#features"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block w-full text-center px-4 py-2 bg-sky-500 hover:bg-sky-400 text-white font-medium rounded-lg transition-colors"
                        >
                            Download App
                        </a>
                    </div>
            ...
            <section className="pt-32 pb-20 px-6">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
                        Practice with an AI examiner that listens, responds, and
                        adapts to your knowledge level. Build confidence through
                        natural conversation, just like the real checkride.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-sky-500/25 hover:shadow-sky-500/40 flex items-center gap-3"
                        >
                            <svg
                                className="w-6 h-6"
                                fill="currentColor"
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-lg text-white">
                                    &ldquo;You&apos;re planning a cross-country
                                    flight and notice the weather briefing
                                    mentions a SIGMET. Can you explain what a
                                    SIGMET is and how it would affect your
                                    flight planning?&rdquo;
                                </p>
                            </div>
                        </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto">
                            PFactor simulates the real oral exam experience with
                            intelligent AI that adapts to your responses.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 hover:border-sky-500/30 transition-colors">
                            ...
                            <p className="text-slate-400">
                                Speak naturally like you would with a real
                                examiner. No typing, no multiple choice - just
                                talk.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 hover:border-sky-500/30 transition-colors">
                            ...
                            <p className="text-slate-400">
                                The AI identifies your weak areas and focuses on
                        ...
                        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 hover:border-sky-500/30 transition-colors">
                            ...
                            <p className="text-slate-400">
                                Questions aligned with the FAA Airman
                                Certification Standards for Private Pilot.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 hover:border-sky-500/30 transition-colors">
                            ...
                            <p className="text-slate-400">
                                See detailed analytics on your performance and
                                watch your confidence grow over time.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 hover:border-sky-500/30 transition-colors">
                            ...
                            <p className="text-slate-400">
                                Get immediate, detailed feedback on your answers
                                with references to FAR/AIM.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="how-it-works" className="py-20 px-6 bg-slate-800/30">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto">
                            Getting started is as easy as starting a
                            conversation.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-slate-400">
                                Select specific topics or let PFactor guide you
                                through a comprehensive oral exam simulation.
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-slate-400">
                                Answer questions by speaking naturally. The AI
                                listens and understands your responses in
                                real-time.
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-slate-400">
                                Receive instant feedback, follow-up questions,
                                and detailed explanations to deepen your
                                understanding.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-gradient-to-r from-sky-500/10 to-blue-500/10 border border-sky-500/20 rounded-3xl p-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                            Get Your "Practice-Factor" On
                        </h2>
                        <p className="text-slate-400 mb-8 max-w-xl mx-auto">
                            Download PFactor today and prepare for your
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-3"
                            >
                                <svg
                                    className="w-6 h-6"
                                    fill="currentColor"
